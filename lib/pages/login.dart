...
//     final userId = prefs.getInt('userId'); // Controlla l'ID utente
...
//   // Mostra un dialog per informare l'utente che è già loggato, con opzione di logout
...
//     SharedPreferences prefs = await SharedPreferences.getInstance();
//     await prefs.remove('userId'); // Cancella l'ID utente salvato
...
//         Uri.parse('http://10.11.11.124:1337/api/auth/login'),
...
//         if (userId != null) {
//           SharedPreferences prefs = await SharedPreferences.getInstance();
//           await prefs.setInt('userId', userId);  // Salva l'ID utente

//           // Mostra un popup di conferma dell'accesso riuscito
//           showDialog(
//             // ignore: use_build_context_synchronously
//             context: context,
//             builder: (context) => AlertDialog(
