...
//           onPressed: () {
//             Navigator.pop(context); // Azione per tornare indietro
//           },
//         ),
...
//               // Divider between Registrati and Accedi button
//               const Text(
//                 '0',
//                 style: TextStyle(fontSize: 16, color: Color.fromRGBO(255, 155, 4, 1)),
//               ),
//               const SizedBox(height: 20),
  ...
  Future<void> _register() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://10.11.11.124:1337/api/logged-users'),
